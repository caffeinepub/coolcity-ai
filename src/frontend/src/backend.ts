...
export class Backend implements backendInterface {
    ...
    async getSimulationCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getSimulationCount();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async recordSimulation(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.recordSimulation();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
